...
class Header extends React.Component {
  constructor(props) {
    super(props);
    this.state = { logo: require("./../../images//logo_web.jpg") };
  }
                  ...
                  <div className="contact-nav">
                    ...
                    <div className="contact-nav-form p-a30">
                      <div className="contact-info   m-b30">
                        ...
                        <div className="mt-icon-box-wraper center p-b30">
                          ...
                          <div className="icon-content">
                            ...
                            <p>thecrownbuilders06@gmail.Com</p>
                          </div>
                        </div>
                        <div className="mt-icon-box-wraper center p-b30">
                          <div className="icon-xs m-b20 scale-in-center">
                          ...
                          <div className="icon-content">
                            ...
                            <p>Suppila Kalady Lane, Dutch Road, Kopay South,<br />Jaffna, Srilanka.</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="text-center">
                        <h4 className="font-weight-600">© 2024 ProWeb Solutions</h4>
                      </div>
                    </div>
                  </div>
                </div>
